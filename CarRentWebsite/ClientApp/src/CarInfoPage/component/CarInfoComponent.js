...
import carDoor from  "./Resource/Images/Icons/carDoor.png"
import conditioner from  "./Resource/Images/Icons/conditioner.png"
                ...
                <Row className={"pt-2"}>
                    ...
                    <Coll xxl={8} xl={7} lg={6} md={5} sm={12} xs={12} className={"pl-lg-5 pl-md-5 pl-sm-5 pl-xs-5 "} >
                        ...
                        <Row lg={4} xxl={4} xl={4} md={4} sm={4} xs={4} className={"pt-3 g-lg-2 g-xxl-2 g-md-1 g-sm-1 px-0 justify-content-center "}>
                            {costs.map((cost,index)=>{return (
                                <Coll><CostCart Period={cost.Time} Cost={cost.Cost}/></Coll>
                                )})}
                        </Row>
                        <Row lg={4} xxl={8} xl={4} md={3} sm={4} xs={4}  className={"gx-lg-4 gx-xxl-5 gx-md-3 gx-sm-1 gx-xs-1 gy-3 pr-0   mb-0 mt-2 justify-content-center  d-flex px-auto"}>
                            {params.map((param,index)=>{return(
